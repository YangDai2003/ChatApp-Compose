...
class ChatScreenRepositoryImpl @Inject constructor(
    ...
    override suspend fun insertMessageToFirebase(
        ...
        try {
            ...
            val notificationJson = JSONObject("{'contents': {'en':'$userEmail: $messageContent'}, 'include_player_ids': ['$oneSignalUserId']}")
            ...
            val updates = mapOf<String, Any>(
                "Friend_List/$registerUUID/lastMessage" to message,
                "Chat_Rooms/$chatRoomUUID/$messageUUID" to message
            )
